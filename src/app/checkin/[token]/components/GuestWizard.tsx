...
type Guest={role:Role;firstName:string;surname1:string;surname2:string;sex:string;birthDate:string;nationality:string;documentType:string;documentNumber:string;documentSupport:string;address:string;locality:string;postalCode:string;country:string;phone:string;email:string;relationshipToAdult:string;signatureData:string}
const blank=(role:Role):Guest=>({role,firstName:'',surname1:'',surname2:'',sex:'',birthDate:'',nationality:'',documentType:'',documentNumber:'',documentSupport:'',address:'',locality:'',postalCode:'',country:'',phone:'',email:'',relationshipToAdult:'',signatureData:''})
...
<Field l={s.postalCode} v={g.postalCode} set={v=>update('postalCode',v)} req/><SelectField
  l={s.country}
  v={g.country}
